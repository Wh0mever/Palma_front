...
interface CategoriesFormFieldsProps extends FormFieldsProps {
  checkIsComposite: boolean
  onCheckedChangeComposite: (e: any) => void
  checkIsForSale: boolean
  onCheckedChangeForSale: (e: any) => void
}
...
const CategoriesFormFields = ({ form, checkIsComposite, checkIsForSale, onCheckedChangeForSale, onCheckedChangeComposite }: CategoriesFormFieldsProps) => {
  ...
  return (
    <>
      ...
      <div className='mt-3 flex flex-col gap-3'>
        <CheckboxFormField
          form={form.control}
          _checked={checkIsComposite}
          _onCheckedChange={onCheckedChangeComposite}
          name='is_composite'
          label='Категория для ингридиентов?'
        />
        <CheckboxFormField
          form={form.control}
          _checked={checkIsForSale}
          _onCheckedChange={onCheckedChangeForSale}
          name='is_for_sale'
